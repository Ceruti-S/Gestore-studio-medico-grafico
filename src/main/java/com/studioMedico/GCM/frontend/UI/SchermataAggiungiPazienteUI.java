...
public class SchermataAggiungiPazienteUI
{

    public void mostraAggiungiPaziente(Stage homeStage) {
        try {
            String pathFXML = "/fxml/AggiungiPaziente.fxml";
            ...
            AggiungiPazienteController controller = new AggiungiPazienteController();

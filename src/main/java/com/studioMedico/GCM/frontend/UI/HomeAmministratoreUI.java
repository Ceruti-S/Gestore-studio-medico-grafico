...
public class HomeAmministratoreUI
{
    ...
    public void mostraHome(Stage homeStage)
    {
        ...
        try
        {
            ...
            String pathFXML = "/fxml/HomeAmministratore.fxml";
            ...
            HomeAmministratoreController controller = new HomeAmministratoreController();

            homeStage.setTitle("GCM - Home Amministratore");

            Scene scene = new Scene(root);
            URL cssLocation = getClass().getResource("/css/Amministratore.css");
            if(cssLocation != null)
            {
        ...
        catch(Exception e)
        {
            ...
            System.err.println("ERRORE FATALE durante il caricamento di HomeAmministratorefxml:");
            e.printStackTrace();

...
public class AggiungiITController
{
    ...
    private void gestisciAggiunta()
    {
        ...
        try
        {
            ...
            CreazioneEliminazionePersone.creaIT("impiegato", titoloInput, nomeInput, cognomeInput, dataInput, cfInput);

            mostraAlert(Alert.AlertType.INFORMATION, "Successo",
                    "L'impiegato IT " + nomeInput + " " + cognomeInput + " è stato registrato.");
        ...
        catch(Exception e)
        {
            ...
            mostraAlert(Alert.AlertType.ERROR, "Errore di Salvataggio",
                    "Impossibile salvare l'impiegato IT: " + e.getMessage());
            e.printStackTrace();
